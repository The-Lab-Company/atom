...
class xeEadPlugin
{
  ...
  public function renderEadId()
  {
    ...
    $institutionResponsibleIdentifier = esc_specialchars($this->resource->institutionResponsibleIdentifier);

    return "<ead:recordid instanceurl=\"$url\">{$institutionResponsibleIdentifier}</ead:recordid>";
  }
